...
def hide4(update, context):
    ...
    encoded_image = encode(image_name=inputimg, secret_data=mes)
...
def main():
   ...
   hide_handler = ConversationHandler(
        ...
        states = {
            ...
            H2: [MessageHandler(Filters.photo, hide2), MessageHandler(Filters.document, hide2b)],
